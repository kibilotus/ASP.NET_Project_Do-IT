        ...
        <div>
            <asp:Table ID="Table1" runat="server" Width="80%" HorizontalAlign="Center">
                ...
                <asp:TableRow>
                    <asp:TableCell style="background-color:whitesmoke;" HorizontalAlign="Right" >
                        <div style="margin-right:30px;">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/imgs/WP3.jpg"  Width="500px" Height="350px"/>
                        </div>
                    ...
                    <asp:TableCell style="width:50%; height:500px; background-color:whitesmoke;" >
                        <div>
                            <div style=" margin-left:30px;">
                                    ...
                                    <div class="class_name">#ASP.NET</div><br />
                                    웹 프로그래밍이 처음이라면, 여기서부터 시작하세요!<br /> 기본 문법을 통한 ASP.NET 기본에 대해 배울 수 있습니다.<br />
                                    ASP.NET를 활용한 코딩 프로젝트를 통하여 누구나 시작할 수 있습니다.
                            </div>
                            <div>
                ...
                <asp:TableRow >
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                        <a name="a"></a>
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/imgs/intro_wp3.jpg" width="1500px"/>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </div>
