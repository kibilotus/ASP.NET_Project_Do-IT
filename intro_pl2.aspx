        ...
        <div>
            <asp:Table ID="Table1" runat="server" Width="80%" HorizontalAlign="Center">
                ...
                <asp:TableRow>
                    <asp:TableCell style="background-color:whitesmoke;" HorizontalAlign="Right" >
                        <div style="margin-right:30px;">
                            <asp:Image ID="Image1" runat="server" ImageUrl="~/imgs/PL2.jpg"  Width="500px" Height="350px"/>
                        </div>
                ...
                <asp:TableRow >
                    <asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
                        <a name="a"></a>
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/imgs/intro_pl2.jpg" width="1500px"/>
                    </asp:TableCell>
                </asp:TableRow>
            </asp:Table>
        </div>
