...
<script runat="server">
    ...
    protected void register_click(Object sender,EventArgs e){
        if (Page.User.Identity.Name == "admin") {
            string sql = "Insert into list(writer ,Title ,Content ,publishedDate) Values(@writer,@Title,@Content,@publishedDate)";
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.Parameters.AddWithValue("@writer", writer.Text);
            cmd.Parameters.AddWithValue("@Title", title.Text);
            cmd.Parameters.AddWithValue("@Content", content.Text);
            cmd.Parameters.AddWithValue("@publishedDate", DateTime.Now.ToShortDateString());
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            ...
            <asp:Table ID="Table1" runat="server" Width="80%" HorizontalAlign="Center">
                ...
                <asp:TableRow >
                    ...
                    <asp:TableRow >
                        <asp:TableCell ColumnSpan="2" style="padding-left:100px;">
                            <p style="color:gainsboro;">HOME>게시판</p>
                            <b style="font-size:40px">게시판 글 작성</b>
                        </asp:TableCell>
                    </asp:TableRow>
				</asp:Table>
				<asp:Table ID="table2" runat="server" Width="40%"  HorizontalAlign="Center" >
						   <asp:TableRow>
								...
								<asp:TableCell>
                                    <asp:Label ID="writer" runat="server" Text="admin"></asp:Label>
								</asp:TableCell>
						   </asp:TableRow>
						   <asp:TableRow>
								<asp:TableHeaderCell>&middot; 제목</asp:TableHeaderCell><asp:TableCell>
								<asp:TextBox runat="server" name="title" size="50" ID="title"  Height="25px" />
								</asp:TableCell>
						   </asp:TableRow>
						   <asp:TableRow>
							...
							<asp:TableRow >
								<asp:TableCell ColumnSpan="2" HorizontalAlign="Center">
									<asp:Button ID="register" runat="server" Text="공지사항 등록" onClick="register_click"/>
								</asp:TableCell>
							</asp:TableRow>
				</asp:Table>
        </div>
